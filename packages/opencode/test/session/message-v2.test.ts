        ...
        content: [
          {
            ...
            toolCallId: "call-1",
            toolName: "bash",
            output: { type: "json", value: { result: "ok", status: "succeeded" } },
          },
        ],
      },
    ])
        ...
        content: [
          {
            ...
            toolCallId: "call-1",
            toolName: "bash",
            output: { type: "json", value: { result: "[Old tool result content cleared]", status: "succeeded" } },
          },
        ],
      },
    ])
        ...
        content: [
          {
            ...
            toolCallId: "call-1",
            toolName: "bash",
            output: { type: "json", value: { error: "nope", status: "failed" } },
            providerOptions: { openai: { tool: "meta" } },
          },
        ],
      },
        ...
        content: [
          {
            ...
            toolCallId: "call-1",
            toolName: "bash",
            output: { type: "json", value: { result: output, status: "succeeded" } },
          },
        ],
      },
    ])
        ...
        content: [
          {
            ...
            toolCallId: "call-pending",
            toolName: "bash",
            output: { type: "json", value: { error: "Tool execution was interrupted", status: "failed" } },
          },
          {
            type: "tool-result",
            toolCallId: "call-running",
